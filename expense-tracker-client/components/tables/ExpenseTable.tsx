...
export function ExpenseTable({ expenses, onEdit, onDelete, currentPage, itemsPerPage }: ExpenseTableProps) {
            ...
            paginatedExpenses.map((expense) => (
              <TableRow key={expense._id} className="hover:bg-gray-50">
                ...
                <TableCell>
                  <Badge 
                    variant="secondary" 
                    className={categoryColors[expense.category] || categoryColors['Others']}
                  >
                    {expense.category}
                  </Badge>
                </TableCell>
